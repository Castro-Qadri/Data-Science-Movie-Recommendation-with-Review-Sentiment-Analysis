    ...
    landing_html = """
        <div class="site-header">
            ...
            <nav class="site-header-nav">
                <span onclick="window.scrollTo({top:0,behavior:'smooth'})">Discover</span>
                <span onclick="document.getElementById('sentiment-section').scrollIntoView({behavior:'smooth'})">Sentiment</span>
                <span onclick="document.getElementById('about-section').scrollIntoView({behavior:'smooth'})">About</span>
            </nav>
        </div>
...
def show_app():
    ...
    with st.sidebar:
        ...
        # Prefill selected movie from landing page link
        prefill_movie = st.session_state.pop("landing_selected_movie", None)
        if prefill_movie and prefill_movie in movie_titles:
